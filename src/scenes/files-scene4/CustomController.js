...
class CustomController {
    ...
    start(character, modelGun) {
        ...
        if(!this.chest) this.chest = character.children[0].children[1].children[1].children[1]//.children[2]
        this.weaponController.setChest(this.chest)
        if(!this.rightHand) this.rightHand = character.children[0].children[1].children[1].children[1].children[3].children[1].children[1].children[1].children[3]
